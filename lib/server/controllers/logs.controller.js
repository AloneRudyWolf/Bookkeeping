...
const getAllAttachments = async (request, response, next) => {
  ...
  const attachments = await new GetAllLogAttachmentsUseCase().execute(value);
...
const getAttachment = async (request, response, next) => {
  ...
  const { result, error } = await new GetLogAttachmentUseCase().execute(dto);
...
const listLogs = async (request, response, next) => {
  ...
  const { count, logs } = await new GetAllLogsUseCase().execute(value);
...
const listTagsByLogId = async (request, response, next) => {
  ...
  const log = await new GetLogUseCase().execute(value);
